...
function App() {
  return (
    <Routes>
      ...
      <Route element={<MainLayout><ProtectedRoute><BookPage /></ProtectedRoute></MainLayout>} path="/book" />
      <Route element={<MainLayout><ProtectedRoute><MyReservationsPage /></ProtectedRoute></MainLayout>} path="/reservations" />
